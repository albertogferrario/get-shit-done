...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /conductor:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/conductor:discuss-phase [current-phase])
2. Create phase plan (/conductor:plan-phase [current-phase])
