...
│   └── gsd/           # Conductor-specific commands
├── conductor/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/conductor/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `conductor/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `conductor/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/conductor/workflows/{name}.md`

**New Reference Document:**
- Implementation: `conductor/references/{name}.md`
