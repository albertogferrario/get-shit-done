...
- This section feeds directly into /conductor:plan-fix
...
5. status → "diagnosed"
6. Ready for /conductor:plan-fix with root causes
...
**Creation:** When /conductor:verify-work starts new session
